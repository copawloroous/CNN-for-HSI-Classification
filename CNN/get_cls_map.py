...
def list_to_colormap(x_list):
    ...
    for index, item in enumerate(x_list):
        ...
        if item == 16:
            ...
            y[index] = np.array([0, 76, 153]) / 255.
        elif item == 26:
            y[index] = np.array([76, 153, 0]) / 255.
        elif item == 27:
            y[index] = np.array([76, 0, 153]) / 255.
        elif item == 28:
            y[index] = np.array([153, 0, 76]) / 255.
        elif item == 29:
            y[index] = np.array([204, 76, 0]) / 255.
...
def generate_classification_map(net, device, data_loader, y, map_index, output_prefix):
    ...
    # classification_map(y_re, y, 300, f'{output_prefix}.eps')
...
def get_cls_map(net, device, all_data_loader, all_data_loader_whole, y):
    ...
    generate_classification_map(net, device, all_data_loader, y, 2, r"./pic/pred_1")
    generate_classification_map(net, device, all_data_loader_whole, y, 1, r"./pic/pred_2")
    ...
    classification_map(gt_re, y, 300, r"./pic/gt")
